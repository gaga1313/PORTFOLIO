...
import universityCover from "../assets/portfolio/university_cover.png"; // Background image
...
const Home = () => {
  ...
  return (
    <div name="Home" className="w-full overflow-hidden">
      ...
      <div className="relative h-screen w-full flex items-center justify-center bg-black">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-white via-white/80 to-white/40 z-10" />

        {/* Content */}
        <div className="relative z-20 max-w-screen-xl mx-auto px-6 flex flex-col md:flex-row items-center justify-center h-full">
          {/* Text Section */}
